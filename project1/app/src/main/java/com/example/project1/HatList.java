...
public class HatList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                * putExtra함수를 사용해서 옷의 image resource Id를 imgRes3이라는 이름을 붙여서 담는다. (string : value)
                * 성공적으로 수행했다는 RESULT_OK 코드를 담고 종료하면, 다시 합성 페이지로 넘어간다. */
                Intent intent = new Intent(HatList.this, Test.class);
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                builder.setPositiveButton("예", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(HatList.this, com.example.project1.Closet.class);
...
//        final InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    private void setData(){
        TypedArray arrResId = getResources().obtainTypedArray(R.array.resId3);
        String[]explains = getResources().getStringArray(R.array.explain3);

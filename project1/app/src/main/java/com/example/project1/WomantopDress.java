...
public class WomantopDress extends Activity implements View.OnTouchListener,View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.womantop_dress);

        ImageView view = (ImageView) findViewById(R.id.womantopimageView1);
    ...
    private void findViews() {
        fullPageScreenshot = (Button) findViewById(R.id.full_page_screenshot2);
        Urlbutton = (Button)findViewById(R.id.urlbutton3);
        rootContent = (LinearLayout) findViewById(R.id.root_content2);
    }
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.full_page_screenshot2){
            takeScreenshot(FULL);
        }
    }
    ...
    public void urlbutton2(View view){

...
public class CameraP extends AppCompatActivity{
...
//        startActivity(intent);
        ...
        // 촬영 버튼을 누르면 사진이 저장된다.
        Button button = (Button)this.findViewById(R.id.btn_take_photo);
    ...
    public void initSurfaceView() {
        ...
        mSurfaceViewHolder.addCallback(new SurfaceHolder.Callback() {
            ...
            //Surface가 준비되면 thread를 시작한다.
            @Override
            public void surfaceCreated(SurfaceHolder holder) {
                initCameraAndPreview();
            }

            //Surface가 소멸되면 thread를 종료한다.
            @Override
    ...
    private CameraDevice.StateCallback deviceStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(CameraDevice camera, int error) {
            Toast.makeText(CameraP.this, "카메라를 열지 못했습니다.", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private CameraCaptureSession.StateCallback mSessionPreviewStateCallback = new CameraCaptureSession.StateCallback() {
        ...
        public void onConfigureFailed(@NonNull CameraCaptureSession session) {
            Toast.makeText(CameraP.this, "카메라 구성 실패", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private class SaveImageTask extends AsyncTask<Bitmap, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(CameraP.this, "사진을 저장했습니다.", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(getApplicationContext(), Test.class);
            startActivity(intent);
        }

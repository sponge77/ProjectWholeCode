...
public class WomanbottomsDress extends Activity implements View.OnTouchListener,View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.womanbottoms_dress);



        ImageView view = (ImageView) findViewById(R.id.womanbottomsimageView1);
    ...
    private void findViews() {
        fullPageScreenshot = (Button) findViewById(R.id.full_page_screenshot3);
        Urlbutton = (Button)findViewById(R.id.urlbutton3);
        rootContent = (LinearLayout) findViewById(R.id.root_content3);
    }
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.full_page_screenshot3){
            takeScreenshot(FULL);
        }
    }
    ...
    public void urlbutton4(View view){
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://wusinsa.musinsa.com/"));
